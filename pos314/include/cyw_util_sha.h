...
#define PBKDF2_SHA256_IMPLEMENTATION 1
...
PBKDF2_SHA256_DEF void sha256_init(CYSHA256_CTX *ctx);
PBKDF2_SHA256_DEF void sha256_update(CYSHA256_CTX *ctx, const uint8_t *m, uint32_t mlen);
// resets state: calls sha256_init
PBKDF2_SHA256_DEF void sha256_final(CYSHA256_CTX *ctx, uint8_t *md);
...
static void sha256_transform(CYSHA256_CTX *s, const uint8_t *buf)
{
...
PBKDF2_SHA256_DEF void sha256_init(CYSHA256_CTX *s)
{
    s->len = 0;
...
PBKDF2_SHA256_DEF void sha256_final(CYSHA256_CTX *s, uint8_t *md)
{
...
PBKDF2_SHA256_DEF void sha256_update(CYSHA256_CTX *s, const uint8_t *m, uint32_t len)
{
    const uint8_t *p = m;
    uint32_t r = s->len % SHA256_BLOCKLEN;
