...
//*******************************************************************
bool                CYReceiptRico::assembleReceiptSignature (Json::Value& jheader)
{   
     _txtsig = "";
     /////////////////////////////////////
     ...
     if (jheader["hdr_tax_receipt"]==Json::nullValue)  {
         ...
         _txtsig += _util->cyLRText(left,"Customer name:", right, tmp);
         _txtsig += _util->cyLRText(left,"Address:", right, tmp);
         _txtsig += _util->cyLRText(left,"TIN:", right, tmp);
