...
//*******************************************************************
#ifndef cy_restreceipt_rico__h
#define cy_restreceipt_rico__h
#include <string>
#include <sstream>
#include <pthread.h>
#include <iostream>
...
//*******************************************************************
class                   CYReceiptRico : public CYRestCommon
{
public:
  ////////////////////////////////////////
  //  Constructor / Destructor
  virtual ~CYReceiptRico ();
  CYReceiptRico (cylog* log, cyini* ini, cycgi* cgi);
  ////////////////////////////////////////
  //  Receipt
  bool                  saveReceipt ();
