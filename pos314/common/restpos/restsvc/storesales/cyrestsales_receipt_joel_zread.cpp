...
//*******************************************************************
bool CYRestReceiptJoelEod::retrieveZread (Json::Value& jheader,
                                          ...
                                          std::string mgrpass)
{
    ...
    if (dbeod->eof ()){
        ...
        jheader["end_num"]=jsettings_register["transaction_count"].asString();
        jheader["start_num"]=jsettings_register["transaction_count"].asString();
        jheader["start_trans"]=jsettings_register["transaction_count"].asString();

        jheader["end_trans"]=jsettings_register["transaction_count"].asString();
        jheader["end_balance"]=jsettings_register["transaction_amount"].asString();
        jheader["start_balance"]=jsettings_register["transaction_amount"].asString();

        jheader["end_trxadjust"]=jsettings_register["adjust_amount"].asString();
        jheader["start_trxadjust"]=jsettings_register["adjust_amount"].asString();

        jheader["end_adjust_balance"]=jsettings_register["last_adjust_amount"].asString();
        jheader["start_adjust_balance"]=jsettings_register["last_adjust_amount"].asString();
    }  else  {
