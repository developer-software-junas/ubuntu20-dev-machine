...
//*******************************************************************
/*bool CYRestCommon::getSalesRecord(Json::Value& jroot,
                                  string systransnum,
...
//*******************************************************************
/*bool CYRestCommon::getFnbRecord(Json::Value& jroot,
                                cyposrest* rest,
                                string table_code,
                                ...
                                string register_number)
{
    ...
    if (systransnum.length() < 1)  {
        ...
        sql += "description, is_default, min_amount, max_amount, is_zero_rated) values (";
        sql += db->sql_bind (idx,systransnum); sql += ", "; idx++;
