...
//*******************************************************************
bool CYRestReceiptSegci::assembleFspUrl(Json::Value& jheader,
                                      Json::Value& jdetail,
                                      Json::Value& jpayment)
{
...
//*******************************************************************
bool CYRestReceiptSegci::xreadSaveTax (string systransnum)
{
    //////////////////////////////////////
    //  Database connection
    CYDbSql* db = dbconn ();
...
// DESCRIPTION:     Create a receipt
//*******************************************************************
bool CYRestReceiptSegci::assembleReceipt(Json::Value& jheader,
                                       Json::Value& jdetail,
                                       Json::Value& jpayment,
...
// DESCRIPTION:     Create a receipt
//*******************************************************************
bool                CYRestReceiptSegci::assembleReceiptClaimStub(Json::Value& jheader,
                                                               Json::Value& jdetail)
{
    if (_isGiftWrap) {
...
// DESCRIPTION:     Create a receipt
//*******************************************************************
bool                CYRestReceiptSegci::assembleReceiptGiftWrap (Json::Value& jheader,
                                                               Json::Value& jdetail)
{
    _txtgift = "";
    if (_isGiftWrap) {
...
// DESCRIPTION:     Create a receipt
//*******************************************************************
bool                CYRestReceiptSegci::assembleReceiptFooter (Json::Value& jheader,
                                                             salesReceiptType receiptType)
{
    _txtfoot = "";
    Json::Value jtemp;
...
// DESCRIPTION:     Create a receipt
//*******************************************************************
bool                CYRestReceiptSegci::assembleReceiptSignature (Json::Value& jheader,
                                                                salesReceiptType receiptType)
{
    _txtsig = "";
    (void)receiptType;
...
// DESCRIPTION:     Create a receipt
//*******************************************************************
bool                CYRestReceiptSegci::assembleVatBreakdown (salesReceiptType receiptType)
{
    _txtvat = "";
    int w = g_widthReceipt;
...
// DESCRIPTION:     Create a receipt
//*******************************************************************
bool CYRestReceiptSegci::assembleReceiptAccount (Json::Value& jheader, salesReceiptType receiptType)
{
    _txtacct = "";
...
// DESCRIPTION:     Create a receipt
//*******************************************************************
bool CYRestReceiptSegci::assembleReceiptPayment (Json::Value& jheader,
                                               Json::Value& jpayment,
                                               salesReceiptType receiptType)
{
    string tmp;
...
// DESCRIPTION:     Create a receipt
//*******************************************************************
bool CYRestReceiptSegci::assembleReceiptTotals (Json::Value& jheader,
                                              salesReceiptType receiptType)
{
    _txttot = "";
    string tmp2 = "", tmp = "";
...
// DESCRIPTION:     Create a receipt
//*******************************************************************
bool CYRestReceiptSegci::assembleReceiptDetail (Json::Value& jdetail,
                                              Json::Value& jhdrtrx,
...
// DESCRIPTION:     Create a receipt
//*******************************************************************
bool CYRestReceiptSegci::assembleReceiptHeader (Json::Value& jheader,
                                              salesReceiptType receiptType)
{
    _txthdr = "";
    _receipt = "";
...
//*******************************************************************
CYRestReceiptSegci::CYRestReceiptSegci (CYDbEnv* env, cycgi* cgi) : CYRestCommon (env, cgi)
{
    _env = nullptr;
    _env = new SqliteEnv;
...
// DESCRIPTION:     One-time iniialization
//*******************************************************************
CYRestReceiptSegci::CYRestReceiptSegci (CYDbEnv* env, cylog* log, cyini* ini, cycgi* cgi)
...
//*******************************************************************
CYRestReceiptSegci::~CYRestReceiptSegci ()
{
    resetEodTotals();
    if (nullptr != _env)
        delete (_env);
...
//*******************************************************************
bool CYRestReceiptSegci::saveReceipt()
{
    return true;
}
