//*******************************************************************
//        FILE:     cyrestsales_xread.cpp
// DESCRIPTION:     JSON schemahdr implementation
//*******************************************************************
...
//*******************************************************************
bool CYRestReceipt::xreadSaveTax (string systransnum)
{
    //////////////////////////////////////
    //  Database connection
    MySqlDb mdb (_ini->_env);
    CYDbSql* db = &mdb;//_ini->dbconn ();
    MySqlDb mdbsel (_ini->_env);
    CYDbSql* dbsel = &mdbsel;//_ini->dbconn ();
    //if (nullptr == db)
