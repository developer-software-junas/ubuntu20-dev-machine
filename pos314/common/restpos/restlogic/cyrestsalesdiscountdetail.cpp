/*****************************************************************************
          FILE:          cyrestsalesdiscountdetail.cpp
 ...
 ***************************************************************************/
bool                     cyrestsalesdiscountdetail::map_argument_cgi (std::string arg,
                                                      std::string name,
                                                      std::string suffix,
                                                      bool validate)  {
 ...
 ***************************************************************************/
bool                     cyrestsalesdiscountdetail::map_argument_cgikey (std::string suffix,
                                                         bool validate)  {
 ...
 ***************************************************************************/
bool                     cyrestsalesdiscountdetail::map_arguments (CYDbSql* db,
                                                   std::string suffix,
                                                   bool validate)  {
  for (int i = 0; i < size (); i++)  {
    CYColumn* col = m_column[i];
 ...
 ***************************************************************************/
void                     cyrestsalesdiscountdetail::reset () {
 ...
 ***************************************************************************/
bool                     cyrestsalesdiscountdetail::copy (cyrestsalesdiscountdetail obj) {
 ...
 ***************************************************************************/
std::string              cyrestsalesdiscountdetail::string_insert ()  {
  std::stringstream sql;
  sql << "insert into ";
  sql << schema_table ();
  sql << " (systransnum, item_seq, discount_code, description";
  sql << ", discount_type, discount_value)  values (";
  ...
  bool                   cyrestsalesdiscountdetail::column_array ()
  {
    CYColumn             *column;
    /////////////////////////////////////
    //  Database table
    m_schema_name  = "cyrestsalesdiscountdetail";
    m_schema_table = "tg_pos_mobile_discount_detail";
    /////////////////////////////////////
