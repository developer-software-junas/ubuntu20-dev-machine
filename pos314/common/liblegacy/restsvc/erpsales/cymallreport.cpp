 ...
 ********************************************************************/
CYRestMallreport::CYRestMallreport (cylog* log, cyini* ini, cycgi* cgi)
 ...
 ********************************************************************/
CYRestMallreport::~CYRestMallreport ()  {
    int j = _transList.size();
    for (int i = 0; i < j; i++)  {
        struct_transactions* trx = _transList.at(i);
        delete (trx);
        trx = nullptr;
    }
}
 ...
 ********************************************************************/
bool                    CYRestMallreport::mallreportAyala (Json::Value& jsales,
                                                           mallSalesType type)
{
    ...
    /////////////////////////////////////
    // Execute Insert to mallreport tables
    if (!mallreportAyalaInsert()) {
...
/********************************************************************
   ...
   DESCRIPTION:         Sales batch processing
 ********************************************************************/
bool                    CYRestMallreport::mallreportAyalaInsert ()
{
...
/********************************************************************
   ...
   DESCRIPTION:         Sales batch processing
 ********************************************************************/
bool                    CYRestMallreport::mallreportMegaworld (Json::Value& jsales,
                                                           mallSalesType type)
{
...
/********************************************************************
      FUNCTION:         batch
   DESCRIPTION:         Sales batch insert
 ********************************************************************/
bool                    CYRestMallreport::mallreportMegaworldInsert () {
