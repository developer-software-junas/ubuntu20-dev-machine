...
//*******************************************************************
#ifndef cy_restreceipt_elena__h
#define cy_restreceipt_elena__h
#include <string>
#include <sstream>
#include <pthread.h>
#include <iostream>
...
//*******************************************************************
class                   CYReceiptElena : public CYRestCommon
{
public:
  ////////////////////////////////////////
  //  Constructor / Destructor
  virtual ~CYReceiptElena ();
  CYReceiptElena (cylog* log, cyini* ini, cycgi* cgi);
  ////////////////////////////////////////
  //  Receipt
  bool                  saveReceipt ();
