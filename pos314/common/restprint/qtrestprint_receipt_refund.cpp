...
/********************************************************************
      FUNCTION:         rest_receipt_refund
   DESCRIPTION:         Print from the database
 ********************************************************************/
std::string             cyposrest::rest_receipt_refund ()
{
    //////////////////////////////////////
    //  Receipt parameters
